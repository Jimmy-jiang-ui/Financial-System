...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'category', name: 'Category', meta: { name: '新闻分类信息' }, component: () => import('../views/manager/Category') },
      { path: 'news', name: 'News', meta: { name: '新闻信息' }, component: () => import('../views/manager/News') },
      { path: 'video', name: 'Video', meta: { name: '新闻信息' }, component: () => import('../views/manager/Video') },
      { path: 'question', name: 'Question', meta: { name: '新闻信息' }, component: () => import('../views/manager/Question') },
      { path: 'answer', name: 'Answer', meta: { name: '新闻信息' }, component: () => import('../views/manager/Answer') },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'question', name: 'Question',component: () => import('../views/front/Question') },
  ...
  { path: '/adminLogin', name: 'Adminlogin', meta: { name: '用户登录' }, component: () => import('../views/AdminLogin.vue') },
