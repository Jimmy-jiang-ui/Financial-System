<template>
    <div class="main-content"style="margin-left: 100px;margin-top: 30px;width: 100%">
        <div style="margin: 10px 0; display: flex; align-items: center;">
            <div style="margin-right: 50px; margin-left:10px;display: flex; align-items: center;">
        ...
        <el-dialog title="新闻信息" :visible.sync="fromVisible" width="50%" :close-on-click-modal="false" destroy-on-close>
            <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
                ...
                <el-form-item label="新闻分类" prop="category">
                    <el-input v-model="form.category" placeholder="新闻分类"></el-input>
                </el-form-item>
