...
<!--                    </template>-->
                    <template v-slot="scope">
                        <video :src="scope.row.file" controls style="width: 200px; border-radius: 15px; border: 2px solid #e0e0e0; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); transition: transform 0.2s;" @mouseover="this.style.transform='scale(1.05)'" @mouseleave="this.style.transform='scale(1)'"></video>
                    </template>
                </el-table-column>
