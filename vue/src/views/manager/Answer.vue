        ...
        <el-dialog title="回答信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
            <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
                ...
                <el-form-item label="回答内容" prop="content">
                    <el-input v-model="form.content" placeholder="回答内容"></el-input>
                </el-form-item>
                <el-form-item label="回答人ID" prop="userId">
                    <el-input v-model="form.userId" placeholder="回答人ID"></el-input>
                </el-form-item>
                <el-form-item label="回答时间" prop="time">
                    <el-input v-model="form.time" placeholder="回答时间"></el-input>
                </el-form-item>
            </el-form>
    ...
    methods: {
        ...
        load(pageNum) {  // 分页查询
            ...
            this.$request.get('/answer/selectPage', {
                ...
                if (res.code === '200') {
                    console.log(res.data?.list); // 调试语句
